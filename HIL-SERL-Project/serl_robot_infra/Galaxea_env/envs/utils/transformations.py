#函数解释
# 大模型“以自我为中心”的空间感知能力。
# construct_transform_matrix (动作变换矩阵 6x6)
# construct_homogeneous_matrix (齐次变换矩阵 4x4)
# construct_adjoint_matrix (伴随矩阵 6x6)
# 带有 _from_euler 后缀的函数

#代码作用
# transformations.py (高级空间坐标系转换)
# 作用：负责极其复杂的 6x6 动作变换矩阵和 4x4 齐次变换矩阵。它是用来把“以世界为中心的坐标”扭曲成“以手心为中心的坐标”的。
# 谁在用它？：中层的包装器 relative_env.py（也就是里面的 DualRelativeFrame 类）。
