...
# 【本次新增修改】
# --------------------------------------------------------------
# 1) 在线 RLPD transition 的单臂夹爪动作，改成与“三值 demos”完全对齐：
#      -1 = close event
#       0 = hold / no-op
#      +1 = open event
# 2) 不再把夹爪在线数据重写成“二值状态流”。
# 3) 调试里的“标签 -> 硬件动作”映射改成：
#      close -> 10
#      open  -> 80
# ==============================================================
...
flags.DEFINE_boolean("minimal_logs", False, "Only keep the most important logs.")
...
#     # 用 demo 推断网络结构时，也先清洗 sample_action。
#     # 这不改变 observation 结构，只确保 sample_action 的数值范围和实际训练一致。
#     sample_transition = sanitize_transition_action_for_storage(
#         get_first_valid_transition(paths),
#         source="sample_demo_infer",
#     )
